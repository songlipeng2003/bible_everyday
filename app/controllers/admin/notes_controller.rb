class Admin::NotesController < Admin::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @note.save
        format.html { redirect_to admin_note_path(@note), notice: 'Note was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @note.update(note_params)
        format.html { redirect_to admin_note_path(@note), notice: 'Note was successfully updated.' }
